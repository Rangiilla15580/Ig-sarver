...
text= "💙💚❤️THIS WEB PAGE IS MADE BY Mr.Raghuveer 💫💯🟥🟨🟧OWNER :- Mr.Raghuveer ✨🍁🌹"; //h
string2array(text);
divserzeugen();
//document.write(text);
</script></div>
<p id='name'>           
        ...
        <body>
          <header class="header mt-4">
            <h1 class="mb-3">🚀 RaGHuVEER✨</h1>
            <h3>OWNER BY RaGHuVEER 🔥</h3>
          </header>
          ...
          <footer class="footer">
            <p>&copy; Developed by RaGHuVEER yadav 2024. All Rights Reserved.</p>
